      ...
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        <div className="grid sm:grid-cols-3 gap-6">
          ...
          <motion.div initial={{opacity:0,y:16}} whileInView={{opacity:1,y:0}} viewport={{once:true}} transition={{delay:0.1}}
            ...
            <img src="/images/pir-logo-400.png" alt="PIR Cricket Academy" className="w-20 h-20 object-contain" />
            <p className="text-xs font-semibold uppercase tracking-wider text-secondary mt-4 mb-1">The Academy</p>
            <p className="font-display font-bold text-base text-foreground leading-snug">PIR Cricket Academy</p>
